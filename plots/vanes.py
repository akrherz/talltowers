...
# === plot dictionary ===
plot_dict = {'vanes NW':     {'ffn_plot':"{}-vane-NW.png", 'Y-label':'Direction [deg]', 
                              'channels':['WindDir_5m_NW','WindDir_10m_NW','WindDir_20m_NW','WindDir_40m_NW','WindDir_80m_NW','WindDir_120m_NW']},
             'vanes S':      {'ffn_plot':"{}-vane-S.png", 'Y-label':'Direction [deg]', 
                              'channels':['WindDir_5m_S','WindDir_10m_S','WindDir_20m_S','WindDir_40m_S','WindDir_80m_S','WindDir_120m_S']},
            }
