...
def get_data():
    conn = psycopg2.connect(database="talltowers", host='talltowers-db.agron.iastate.edu',
                            user='tt_web')
...
ax.set_title(("ISU Atmospheric Observatory :: Hamilton County Tall Tower\n"
...
ax.xaxis.set_major_locator(mdates.MinuteLocator(byminute=[0, 15, 30, 45], tz=TZ))
